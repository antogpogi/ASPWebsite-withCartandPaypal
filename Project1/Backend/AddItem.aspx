<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/BackMasterPage.master" AutoEventWireup="true" CodeFile="AddItem.aspx.cs" Inherits="Backend_AddUser" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">Hand Armor | Add Item
</asp:Content>
        ...
        <div class="container">
            <div>
                <table>
                    ...
                    <tr>
                        <td colspan="10">
                            <p>Description</p>      <%-- Query nalang tapos yung mga textbox. yosi lng --%>
                    ...
                    <tfoot>
                        <tr>
                            <td>
                                <asp:Button ID="ButtonUpdate"  runat="server" Text="Submit" OnClick="ButtonUpdate_Click" />
